...
"NO_PAGE_SELECTED"    =>  "Página no seleccionada",
...
"EXCERPT_LENGTH"      =>  "Longitud de extracto (en caracteres)",
...
"BY_MONTH"            =>  "Por meses",
"BY_YEAR"             =>  "Por años",
"READ_MORE_LINK"      =>  "Añadir enlace \"leer más\" a los extractos",
"ALWAYS"              =>  "Siempre",
...
"IMAGE_LINKS"         =>  "Enlazar imágenes a entradas",
"IMAGE_WIDTH"         =>  "Anchura de imagen (pixels)",
"IMAGE_HEIGHT"        =>  "Altura de imagen (pixels)",
"FULL"                =>  "completa",
"IMAGE_CROP"          =>  "Recortar imagen adaptándola al tamaño",
...
"TAGS"                =>  "Etiquetas",
"OLDER_POSTS"         =>  "&larr; Anteriores",
"NEWER_POSTS"         =>  "Siguientes &rarr;",
"SEARCH"              =>  "Buscar",
